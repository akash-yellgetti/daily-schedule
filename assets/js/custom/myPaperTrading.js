...
trader.buy('AAPL', 10, 160); // Buy 10 AAPL at $150
trader.displayPortfolio();
trader.buy('AAPL', 10, 170); // Buy 10 AAPL at $150
trader.displayPortfolio();
// Execute some buy and sell trades
trader.sell('AAPL', 5, 178); // Sell 15 AAPL at $160 (even though only 10 were bought)
trader.displayPortfolio();
trader.sell('AAPL', 5, 182); // Sell 15 AAPL at $160 (even though only 10 were bought)
trader.displayPortfolio();
trader.sell('AAPL', 5, 155); // Sell 15 AAPL at $160 (even though only 10 were bought)
trader.displayPortfolio();
trader.sell('AAPL', 5, 160); // Sell 15 AAPL at $160 (even though only 10 were bought)
trader.displayPortfolio();
